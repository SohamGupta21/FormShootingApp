...
//  ShootingApp
//
//  Created by soham gupta on 7/18/21.
//
...
// code from: https://stackoverflow.com/questions/30470154/create-movie-from-uiimage-swift
class VideoConverter {
    ...
    func buildVideoFromImageArray(framesArray:[UIImage]) -> URL {
        if framesArray == [] {
